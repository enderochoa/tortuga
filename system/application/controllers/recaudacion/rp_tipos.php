<?php
class rp_tipos extends Controller {
	var $titp='Tipos de Publicidad';
	var $tits='Tips de Publicidad';
	var $url ='recaudacion/rp_tipos/';
	function rp_tipos(){
		parent::Controller();
	...
	function filteredgrid(){
		...
		$filter = new DataFilter($this->titp, 'rp_tipos');
	...
	function dataedit(){
		...
		$edit = new DataEdit($this->tits, 'rp_tipos');
