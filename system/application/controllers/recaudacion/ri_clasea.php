<?php
class Ri_clasea extends Controller {
	var $titp='Clases Aseo';
	var $tits='Clase de Aseo';
	var $url ='recaudacion/ri_clasea/';
	function Ri_clasea(){
		parent::Controller();
	...
	function filteredgrid(){
		...
		$filter = new DataFilter($this->titp, 'ri_clasea');
	...
	function dataedit(){
		...
		$edit = new DataEdit($this->tits, 'ri_clasea');
