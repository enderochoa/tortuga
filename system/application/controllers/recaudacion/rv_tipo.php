<?php
class rv_tipo extends Controller {
	var $titp='Tipos de Vehiculos';
	var $tits='Tipo de Vehiculo';
	var $url ='recaudacion/rv_tipo/';
	function rv_tipo(){
		parent::Controller();
		$this->load->library("rapyd");
		$this->datasis->modulo_id(406,1);
	}
	function index(){
	...
	function filteredgrid(){
		...
		$filter = new DataFilter($this->titp, 'rv_tipo');
	...
	function dataedit(){
		...
		$edit = new DataEdit($this->tits, 'rv_tipo');
