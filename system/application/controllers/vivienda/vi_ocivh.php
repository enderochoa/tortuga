<?php
class vi_ocivh extends Controller {
	var $titp='';
	var $tits='';
	var $url ='vivienda/vi_ocivh/';
	function vi_ocivh(){
		parent::Controller();
	...
	function filteredgrid(){
		...
		$filter = new DataFilter($this->titp, 'vi_ocivh');
	...
	function dataedit(){
		...
		$edit = new DataEdit($this->tits, 'vi_ocivh');
