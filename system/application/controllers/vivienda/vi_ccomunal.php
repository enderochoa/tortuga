<?php
class vi_ccomunal extends Controller {
	var $titp='Consejos Comunales';
	var $tits='Consejo Comunal';
	var $url ='vivienda/vi_ccomunal/';
	function vi_ccomunal(){
		parent::Controller();
		$this->load->library("rapyd");
		$this->datasis->modulo_id(383,1);
	}
	function index(){
	...
	function filteredgrid(){
		...
		$filter = new DataFilter($this->titp, 'vi_ccomunal');
	...
	function dataedit(){
		...
		$edit = new DataEdit($this->tits, 'vi_ccomunal');
