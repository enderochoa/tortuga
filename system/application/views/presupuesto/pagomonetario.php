	...
	<tr>
		<td>
			...
			<table width='100%' bgcolor="#FFEAEB">
				...
				<tr>
					<td class="littletableheaderb" align='center' > <? echo $form->total->label.$form->total->output  ?></th>
				</tr>
				<tr>
					<th class="littletableheaderb" > </th>
				</tr>
			...
			<br />
			 ...
			 <table width='100%'>
			  ...
			  <tr >
			  	<td class="littletablerow" align='right' colspan="2" ><?=$form->simptimbre->label  ?></td>
			    <td class="littletablerow" align='right'             ><?=$form->simptimbre->output ?></td>
			  ...
			  <tr>
			  	<td  class="littletablefooterb" align='right' colspan="7"></td>
