...
foreach($form->detail_fields['itrequi'] AS $ind=>$data)
	$campos[]=$data['field'];
$campos='<tr id="tr_itrequi_<#i#>"><td class="littletablerow">'.join('</td><td>',$campos).'</td>';
$campos=str_replace("\n",'',$campos);
	...
	<tr>
		<td>
			<table width="100%"  style="margin:0;width:100%;">
			  <tr>
			    <td colspan=6 class="bigtableheader">Requisici&oacute;n Nro. <?php  echo str_pad(trim($form->numero->output),8,0,STR_PAD_LEFT) ?></td>
			  </tr>
			  <tr>                                                                        
			...
			<table width='100%'>
     		<tr>
			  ...
			  <tr id='tr_itrequi_<?=$i ?>'>
			    ...
			    <?php if($form->_status!='show') {?>
			    <td class="littletablerow"><a href=# onclick='del_itrequi(<?=$i ?>);return false;'>Eliminar</a></td>
			    <?php } ?>
			  </tr>
			  <?php } ?>
			  <tr id='__UTPL__'>
