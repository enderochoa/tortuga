...
require_once($_SERVER['DOCUMENT_ROOT'].base_url().'phpfreechat/src/pfccommand.class.php');
require_once($_SERVER['DOCUMENT_ROOT'].base_url().'phpfreechat/src/pfcglobalconfig.class.php');
require_once($_SERVER['DOCUMENT_ROOT'].base_url().'phpfreechat/src/pfcuserconfig.class.php');
require_once($_SERVER['DOCUMENT_ROOT'].base_url().'phpfreechat/src/pfctemplate.class.php');
require_once($_SERVER['DOCUMENT_ROOT'].base_url().'phpfreechat/lib/utf8/utf8_substr.php');
require_once($_SERVER['DOCUMENT_ROOT'].base_url().'phpfreechat/src/pfcresponse.class.php');
...
class PhpFreeChat
{
  ...
  function &loadStyles($theme = 'default', &$xml_reponse)
  {
    ...
    require_once $_SERVER['DOCUMENT_ROOT'].base_url().'phpfreechat/lib/ctype/ctype.php'; // to keep compatibility for php without ctype support
    require_once $_SERVER['DOCUMENT_ROOT'].base_url().'phpfreechat/lib/csstidy-1.2/class.csstidy.php';
    $css = new csstidy();
  ...
  function &loadScripts($theme, &$xml_reponse)
  {
    ...
    // load translations
    require_once $_SERVER['DOCUMENT_ROOT'].base_url().'phpfreechat/src/pfcjson.class.php';
    $json = new pfcJSON();
