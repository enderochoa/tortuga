...
class Bienvenido extends Controller {
	...
	function autentificar(){
		...
		$query ="SELECT us_nombre FROM usuario WHERE us_codigo='$usr' AND us_clave='$pws' ";
		else
		$query ="SELECT us_nombre FROM usuario WHERE us_codigo='$usr' AND us_clave='$pws' AND internet='S' ";
