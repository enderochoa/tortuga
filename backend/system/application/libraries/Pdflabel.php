...
//		$this->MultiCell($this->_Width, $this->_Line_Height, $texte,1);
		...
		$this->Cell($this->_Width, 7,  $texte[0],'LTRB',2,'C');
		$this->SetFont('Arial','B',35);
		$this->Cell($this->_Width, 13, $texte[1],'LR',2,'C');
		$this->SetFont('Arial','',10);
		$this->Cell($this->_Width, 7,  $texte[2],'LR',2,'C');
		$this->SetFont('Arial','B',10);
		$this->Cell($this->_Width, 7,  $texte[3],'TLRB',2,'C');
